...
ui <- fluidPage(
  ...
  fluidRow(
    column(12, 
           tags$a(href="https://rpubs.com/FaisalSazali1988/Shinyapp_CareerSight_User_Manual", "Click here to access the user manual"), 
           align = "left",
           style = paste("padding-top: ", top_padding, "; padding-left: ", col_padding, "; padding-right: ", col_padding, ";", sep="")
  )),
  column(
    6,
  ...
  output$estimation <-
    renderText(
      paste(
        ...
        "vacancies require a",
        colnames(vie)[which(voe[input$Occupation,-ncol(voe)] == max(voe[input$Occupation,-ncol(voe)]))],
